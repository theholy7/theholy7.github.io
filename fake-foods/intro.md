...
1. Scrape recipe URLs off several food websites;
2. Scrape the ingredients and methods each recipe has;
3. Explore the obtained data using best practice with [Data Science Cookie Cutter](https://drivendata.github.io/cookiecutter-data-science/);
4. Develop a Flask API to deliver the model created;
5. Containarize the app and release it into the world;
6. Develop the website to post all the fake food.
